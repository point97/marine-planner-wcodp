(function(){
    ...
    OpenLayers.Strategy.Cluster = OpenLayers.Class(OpenLayers.Strategy, {
        ...
        /* onStartClustering Callback - used to notify caller that clustering has started */
        onStartClustering: function() {},

        /* onFinishClustering Callback - used to notify caller that clustering has ended */
        onFinishClustering: function() {},
    ...
    window['P97']['Strategies'] = window.P97.Strategies || {};
    window['P97']['Strategies']['AttributeCluster'] = OpenLayers.Strategy.AttributeCluster;
