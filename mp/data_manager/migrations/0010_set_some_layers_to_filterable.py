...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            derelict_gear = Layer.objects.get(name='Derelict Gear')
            derelict_gear.filterable = True
            derelict_gear.save()
        except Layer.DoesNotExist:
            pass

        try:
            beach_cleanups = Layer.objects.get(name='Beach Cleanups')
            beach_cleanups.filterable = True
            beach_cleanups.save()
        except Layer.DoesNotExist:
            pass
    ...
    def backwards(self, orm):
        ...
        try:
            derelict_gear = Layer.objects.get(name='Derelict Gear')
            derelict_gear.filterable = False
            derelict_gear.save()
        except Layer.DoesNotExist:
            pass
        ...
        try:
            beach_cleanups = Layer.objects.get(name='Beach Cleanups')
            beach_cleanups.filterable = False
            beach_cleanups.save()
        except Layer.DoesNotExist:
            pass
